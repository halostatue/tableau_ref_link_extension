defmodule TableauRefLinkExtension.MixProject do
  use Mix.Project

  @app :tableau_ref_link_extension
  @project_url "https://github.com/halostatue/tableau_ref_link_extension"
  @version "1.0.0"

  def project do
    [
      app: @app,
      description: "A Reference Link Resolution Extension for Tableau",
      version: @version,
      source_url: @project_url,
      name: "TableauRefLinkExtension",
      elixir: "~> 1.18",
